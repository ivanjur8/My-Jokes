...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="position: fixed;width: 100%">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="#">Ironija</a>
						<a class="dropdown-item" href="#">Sarkazam</a>
						<a class="dropdown-item" href="#">Satira</a>
						<a class="dropdown-item" href="#">Parodija</a>
					</div>
				</li>
				<li class="nav-item">
		    ...
		    <form  class="form-inline my-2 my-lg-0" action="inclaudes/login.inc.php" method="post">
            ...
            <button class="btn-group-toggle"  type="submit" name="signeup-submit"><a href="signup.php">Registriraj se</a> </button> 
